...
public struct SymbolSearchResponse {
  ...
  public var symbols: [StockSymbol] = []
...
public struct StockSymbol {
  ...
  public var marketOpen: String = String()

  public var marketClose: String = String()

  public var timezone: String = String()

  public var currency: String = String()

  public var matchScore: String = String()
...
extension SymbolSearchResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SymbolSearchResponse"
  ...
  public static func ==(lhs: SymbolSearchResponse, rhs: SymbolSearchResponse) -> Bool {
...
extension StockSymbol: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".StockSymbol"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: StockSymbol, rhs: StockSymbol) -> Bool {
